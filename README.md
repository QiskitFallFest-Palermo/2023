...
This repository contains the generated website for the **Qiskit Fall Fest
2023 @ Palermo**.

Visit the website at
[qiskitfallfest-palermo.github.io/2023](https://qiskitfallfest-palermo.github.io/2023/).

## Event

The Qiskit Fall Fest brought together students, researchers, and quantum
computing enthusiasts to explore quantum computation, learn Qiskit, and work on projects and challenges.
...
1. Proper attribution to the original authors. Retain the following attribution in documentation or credits:
   ```
	...
	The original repository is available at https://github.com/QiskitFallFest-Palermo/2023 .
   ```
